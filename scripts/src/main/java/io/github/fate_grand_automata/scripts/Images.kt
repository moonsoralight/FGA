...
enum class Images(val path: String) {
    ...
    CommandSpellReviveEnabled("command_spell_revive_enabled.png"),
    ...
    GrandCeLabelCn("grand_ce_label_cn.png"),
    BondCeEmptyCn("bond_ce_empty_cn.png"),
    BondCeEffectDefaultCn("bond_ce_effect_default_cn.png"),
    HakunoName("hakuno_name.png"),
    HakunoEnergyInsufficient("hakuno_energy_insufficient.png"),
    HakunoEnergyClose("hakuno_energy_close.png"),
    DreamFireBondMax("dream_fire_bond_max.png"),
    DreamFireMenu("dream_fire_menu.png"),
    DreamFireStrengthen("dream_fire_strengthen.png"),
    DreamFireStrengthenTitle("dream_fire_strengthen_title.png"),
    DreamFireBondUnlock("dream_fire_bond_unlock.png"),
    DreamFirePlus("dream_fire_plus.png"),
    DreamFireCanOpen("dream_fire_can_open.png"),
    DreamFireBackClose("dream_fire_back_close.png"),
    DreamFireOpen("dream_fire_open.png"),
    DreamFireConfirm("dream_fire_confirm.png"),
